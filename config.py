...
KELLY_FRACTION = 0.5        # quarter Kelly for safety
...
BANKROLL = 30.00            # USD (UPDATE THIS to your actual contest bankroll)
...
LLM_BASE_URL = os.getenv("LLM_BASE_URL", "https://api.ai.it.ufl.edu/v1")
